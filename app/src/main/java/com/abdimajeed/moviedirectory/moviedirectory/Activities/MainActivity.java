package com.abdimajeed.moviedirectory.moviedirectory.Activities;
//
...
import com.abdimajeed.moviedirectory.moviedirectory.Data.MovieRecyclerViewAdapter;
import com.abdimajeed.moviedirectory.moviedirectory.Model.Movie;
import com.gohool.moviedirectory.moviedirectory.R;
import com.abdimajeed.moviedirectory.moviedirectory.Util.Constants;
import com.abdimajeed.moviedirectory.moviedirectory.Util.Prefs;
                ...
                try {
                    ...
                    for (int i = 0; i < moviesArray.length(); i++) {
                        ...
                        if (movieObj.getString("Type").equalsIgnoreCase("movie")) {
                            ...
                            movie.setMovieType("Type: " + movieObj.getString("Type").substring(0, 1).toUpperCase() + movieObj.getString("Type").substring(1));
